...
<!-- Mirrored from html.laralink.com/invoma/general_7.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Aug 2025 06:05:22 GMT -->
...
<head>
    ...
    <!-- Site Title -->
    <title>Invoice Billing <?=$invoice?></title>
                ...
                <div class="tm_invoice_in">
                        ...
                        <div class="tm_invoice_right">
                            <div class="tm_grid_row tm_col_3">
                                <div class="tm_text_center">
                                    ...
                                    <a href="https://html.laralink.com/cdn-cgi/l/email-protection" class="__cf_email__"
                                        data-cfemail="5e2d2b2e2e312c2a1e39333f3732703d3133">[email&#160;protected]</a>
                                    <br>
                                    <a href="https://html.laralink.com/cdn-cgi/l/email-protection" class="__cf_email__"
                                        data-cfemail="650f0a0716250208040c094b060a08">[email&#160;protected]</a>
                                </div>
                                <div class="tm_text_center">
                                    <p class="tm_accent_color tm_mb0">
                                        <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24"
                    ...
                    <div class="tm_invoice_info tm_mb30 tm_align_center">
                        <div class="tm_invoice_info_left tm_mb20_md">
                            <p class="tm_mb0">
                                <b class="tm_primary_color">Invoice No: </b>#LL93784 <br>
                                <b class="tm_primary_color">Invoice Date: </b>10 March 2022
                            </p>
                        </div>
                        <div class="tm_invoice_info_right">
                            <div
                                ...
                                <div>
                                    <b class="tm_accent_color tm_f26 tm_medium tm_body_lineheight">Total: $10,000</b>
                                </div>
                            </div>
                        </div>
                    </div>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="tm_width_6 tm_border_top_0">
                                                <b class="tm_primary_color tm_medium">Name: </b>Lowell H. Dominguez
                                            </td>
                                            <td class="tm_width_6 tm_border_top_0 tm_border_left tm_accent_border_20">
                                                <b class="tm_primary_color tm_medium">Phone: </b> +99-098-234-984
                                            </td>
                                        </tr>
                                        <tr>
                                            <td class="tm_width_6 tm_accent_border_20">
                                                <b class="tm_primary_color tm_medium">Email: </b><a
                                                    href="https://html.laralink.com/cdn-cgi/l/email-protection"
                                                    class="__cf_email__"
                                                    data-cfemail="4f2b2a22200f28222e2623612c2022">[email&#160;protected]</a>
                                            </td>
                                            <td class="tm_width_6 tm_border_left tm_accent_border_20">
                                                <b class="tm_primary_color tm_medium">Address: </b>84 Spilman Street,
                        ...
                        <div class="tm_border tm_accent_border_20">
                            <div class="tm_table_responsive">
                                <table>
                                    ...
                                    <tbody>
                                        <tr>
                                            <td class="tm_width_3 tm_accent_border_20">1. Website Design</td>
                                            <td class="tm_width_4 tm_accent_border_20">Six web page designs and three
                                                times revision</td>
                                        ...
                                        <tr>
                                            <td class="tm_width_3 tm_accent_border_20">2. Web Development</td>
                                            <td class="tm_width_4 tm_accent_border_20">Convert pixel-perfect frontend
                                                and make it dynamic</td>
                                            <td class="tm_width_2 tm_accent_border_20">$600</td>
                                            <td class="tm_width_1 tm_accent_border_20">1</td>
                                            <td class="tm_width_2 tm_accent_border_20 tm_text_right">$600</td>
                                        </tr>
                                        <tr>
                                            <td class="tm_width_3 tm_accent_border_20">3. App Development</td>
                                            <td class="tm_width_4 tm_accent_border_20">Android & Ios Application
                                                Development</td>
                                        ...
                                        <tr>
                                            <td class="tm_width_3 tm_accent_border_20">4. Digital Marketing</td>
                                            <td class="tm_width_4 tm_accent_border_20">Facebook, Youtube and Google
                                                Marketing</td>
                        ...
                        <div class="tm_invoice_footer tm_type1">
                            ...
                            <div class="tm_right_footer">
                                <div class="tm_sign tm_text_center">
                                    <img src="<?=base_url()?>invoice/assets/img/sign.svg" alt="Sign">
                    ...
                    <div class="tm_bottom_invoice tm_accent_border_20">
                        <div class="tm_bottom_invoice_left">
                            ...
                            <p class="tm_m0 tm_f12">IInvoice was created on a computer and is valid without the
                                signature and seal.</p>
                        </div>
                        <div class="tm_bottom_invoice_right tm_mobile_hide">
                            <div class="tm_logo"><img src="<?=base_url()?>invoice/assets/img/logo_accent.svg"
                                    alt="Logo"></div>
                        </div>
                    </div>
                </div>
    ...
    (function() {
        function c() {
            ...
            if (b) {
                ...
                d.innerHTML =
                    "window.__CF$cv$params={r:'96febd53dd519b8b',t:'MTc1NTMyNDMyMQ=='};var a=document.createElement('script');a.src='../cdn-cgi/challenge-platform/h/b/scripts/jsd/4710d66e8fda/maind41d.js';document.getElementsByTagName('head')[0].appendChild(a);";
...
<!-- Mirrored from html.laralink.com/invoma/general_7.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 16 Aug 2025 06:05:24 GMT -->
